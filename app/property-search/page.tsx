  ...
  return(
    <div className="max-w-screen-lg mx-auto">
      ...
      <div className="grid grid-cols-3 mt-5 gap-5">
        ...
        {data.map((property)=>{
          const addressLines = [property.address1,property.address2,property.postcode].filter(addressLine=>!!addressLine).join(", ")
          return(
...
{(!verifiedToken|| !verifiedToken.admin) &&    (  <ToggleFavouriteButton isFavourite={userFavourites[property.id]} propertyId={property.id}/>)}
        {!!property.images?.[0] && 
        <Image fill className="object-cover" src={ImageUrlFormatter(property.images[0])} alt={""}/> 
        }
